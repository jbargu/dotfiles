...
inoremap <expr> <Plug>CustomCocCR coc#pum#visible() ? coc#pum#confirm()
			      \: "\<C-g>u\<CR>\<c-r>=coc#on_enter()\<CR>"
...
" Manage extensions.
nnoremap <silent><nowait> <space>r  :CocCommand workspace.diagnosticRelated<cr>
" Show commands.
